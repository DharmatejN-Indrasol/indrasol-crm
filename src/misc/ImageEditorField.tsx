...
const ImageEditorDialog = (props: ImageEditorDialogProps) => {
    ...
    return (
        <Dialog
            ...
            fullWidth
            maxWidth="md"
            aria-labelledby="image-editor-dialog-title"
        >
            {props.type === 'avatar' && (
                <style>
                    {`
            ...
            <DialogTitle id="image-editor-dialog-title">Upload and resize image</DialogTitle>
            ...
            <Box sx={{ borderTop: '1px solid #e0e7ef', px: 2, py: 1.5, display: 'flex', gap: 1, justifyContent: 'space-between' }}>
