    ...
    return (
        ...
        >
            ...
            <Stack gap={1} alignItems="center">
                <Typography variant="h6" fontWeight="bold">No companies found</Typography>
                <Typography variant="body2" align="center" color="text.secondary" gutterBottom>It seems your company list is empty.</Typography>
            </Stack>
