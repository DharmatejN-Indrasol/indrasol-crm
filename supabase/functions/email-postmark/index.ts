...
/* To invoke locally:
  ...
  3. OPTIONAL: Create a Contact with email "firstname.lastname@Indrasollab.com"
  ...
  curl -i --location --request POST 'http://127.0.0.1:54321/functions/v1/postmark' \
    ...
    --data '{
        ...
        "To": "\"Firstname Lastname\" <firstname.lastname@Indrasollab.com>",
        "ToFull": [
            {
        ...
        "OriginalRecipient": "firstname.lastname@Indrasollab.com",
